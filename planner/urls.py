...
urlpatterns = [
    ...
    path('api/categories/<int:cat_id>/edit/', views.api_edit_category, name='api-edit-category'),
    path('api/categories/<int:cat_id>/delete/', views.api_delete_category, name='api-delete-category'),
